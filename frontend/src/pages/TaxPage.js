...
function CgtSummaryCards({ summary }) {
    ...
    return (_jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [_jsx(TaxCard, { label: "Gross Capital Gains", value: fmtCcy(summary.totalCapitalGains), icon: _jsx(TrendingUp, { size: 15 }), positive: true }), _jsx(TaxCard, { label: "Capital Losses", value: fmtCcy(summary.totalCapitalLosses), icon: _jsx(TrendingDown, { size: 15 }), positive: false }), _jsx(TaxCard, { label: "50% CGT Discount", value: `− ${fmtCcy(summary.cgDiscountAmount)}`, icon: _jsx(Shield, { size: 15 }), neutral: true, sub: "On assets held > 12 months" }), _jsx(TaxCard, { label: "Net Assessable CGT", value: fmtCcy(net), positive: netPositive, icon: netPositive ? _jsx(TrendingUp, { size: 15 }) : _jsx(TrendingDown, { size: 15 }), highlight: true, sub: summary.lossesCarriedForward > 0
