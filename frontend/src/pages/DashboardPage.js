...
export default function DashboardPage() {
    ...
    const cellAlign = (align) => align === 'right' ? 'text-right' : 'text-left';
    if (!activePortfolio) {
